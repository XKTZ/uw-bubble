...
public class JwtTokenUtil implements Serializable {
    ...
    public String generateSessionToken(UserDetails userDetails) {
        ...
        return doGenerateToken(claims, userDetails.getUsername(), SESSION_TOKEN_VALIDITY);
    }

    public String generateVerificationToken(UserDetails userDetails) {
        Map<String, Object> claims = new HashMap<>();
        return doGenerateToken(claims, userDetails.getUsername(), VERIFICATION_TOKEN_VALIDITY);
    }
